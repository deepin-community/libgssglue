...
gss_canonicalize_name(OM_uint32 * minor_status,
		      ...
		      const gss_OID mech_type, gss_name_t * canon_name)
{
    OM_uint32       minor,
                    status;
    gss_union_name_t union_input_name,
                    union_canon_name;
	...
	*minor_status = ENOMEM;
	...
	__gss_release_internal_name(&minor, &mech->mech_type,
				    &internal_name);
    }
