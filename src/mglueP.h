...
typedef struct gss_mech_spec_name_t {
    gss_OID         name_type;
    gss_OID         mech;
    struct gss_mech_spec_name_t *next,
                   *prev;
...
typedef struct gss_config {
    ...
    void           *context;
		     ...
		     void **	/* internal context */
                    ...
                    OM_uint32(*gss_free_lucid_sec_context)
                    (OM_uint32 *,	/* minor_status */
		     void *	/* internal context */
	);
...
OM_uint32       __gss_import_internal_name(OM_uint32 *, gss_OID,
					   gss_union_name_t, gss_name_t *);
OM_uint32       __gss_display_internal_name(OM_uint32 *, gss_OID,
					    gss_name_t, gss_buffer_t,
					    gss_OID *);
OM_uint32       __gss_release_internal_name(OM_uint32 *, gss_OID,
					    gss_name_t *);

OM_uint32       __gss_convert_name_to_union_name(OM_uint32 *,	/* minor_status
								 */
						 gss_mechanism,	/* mech */
...
gss_cred_id_t   __gss_get_mechanism_cred(gss_union_cred_t,	/* union_cred
								 */
					 gss_OID	/* mech_type */
    );

OM_uint32       __gss_copy_namebuf(gss_buffer_t src, gss_buffer_t * dest);

OM_uint32       generic_gss_release_oid(OM_uint32 *,	/* minor_status */
					gss_OID *	/* oid */
    );

OM_uint32       mech_gss_release_oid(OM_uint32 *,	/* minor_status */
				     gss_OID *,	/* oid */
				     gss_mechanism	/* gss_mech */
    );
